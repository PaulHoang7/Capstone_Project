#!/usr/bin/env bash
# Round 3: retrain trên GT đã CHUẨN HOÁ QUY ƯỚC (in hoa, '!' tách space, bỏ space
...
V4=$CKPT/qwen25vl_7b_vncomic_uppercase_lora_v4_norm
...
"$PY" eval_ocr_bubble.py \
    ...
    --out-csv "$CSVD/eval_pred_v4_norm.csv"
